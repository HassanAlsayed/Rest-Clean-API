...
namespace HR.LeaveManagmant.Persistence.Migrations
{
    ...
    [Migration("20240820111308_added refresh token table")]
            ...
            modelBuilder.Entity("HR.LeaveManagmant.Domain.Entities.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d521425d-ec13-4c2c-aca2-cac12b2bc435"),
                            CreatedDate = new DateTime(2024, 8, 20, 13, 13, 8, 219, DateTimeKind.Local).AddTicks(9075),
                            DefaultDays = 10,
                            ModifiedDate = new DateTime(2024, 8, 20, 13, 13, 8, 219, DateTimeKind.Local).AddTicks(9093),
                            Name = "Vacation"
                        });
                });

            modelBuilder.Entity("HR.LeaveManagmant.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
